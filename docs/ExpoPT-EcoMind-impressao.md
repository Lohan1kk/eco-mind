...
ExpoPT 2026 — Documentação do projeto (versão para impressão)

EcoMind
Consciência ambiental + tecnologia

2º Ano — Técnico em Desenvolvimento de Sistemas
Tema: Voluntariado para o Meio Ambiente: tecnologia e ação em defesa da Vida Terrestre
Foco: ODS 15 — Vida Terrestre
Entrega da pesquisa: 18 de setembro de 2026

Integrantes:
Ana Flávia — CEO / Design
Lucas Lohan — CTO / UX-UI
André Zauli — Tecnologia / Programação
...
Problema de partida: Desmatamento e queimadas — e a sensação de impotência que impede a participação voluntária.
...
2.1 O problema ambiental: desmatamento e queimadas
...
2.3 Relação com a ODS 15 — Vida Terrestre
...
2.4 Importância do voluntariado
...
2.5 Exemplos de ações voluntárias e iniciativas reais
...
2.6 Como a tecnologia pode contribuir
...
1. INSTITUTO NACIONAL DE PESQUISAS ESPACIAIS (INPE). Programa Queimadas. Disponível em: https://queimadas.dgi.inpe.br/. Acesso em: 2026.
2. ORGANIZAÇÃO DAS NAÇÕES UNIDAS (ONU). Objetivo de Desenvolvimento Sustentável 15 — Vida terrestre. Agenda 2030. Disponível em: https://brasil.un.org/pt-br/sdgs/15. Acesso em: 2026.
3. NAÇÕES UNIDAS. Transformando Nosso Mundo: a Agenda 2030 para o Desenvolvimento Sustentável. 2015.
4. MINISTÉRIO DO MEIO AMBIENTE E MUDANÇA DO CLIMA (Brasil). Políticas e informações sobre florestas, biodiversidade e combate a incêndios. Portal gov.br. Acesso em: 2026.
5. NASA FIRMS. Fire Information for Resource Management System. Disponível em: https://firms.modaps.eosdis.nasa.gov/. Acesso em: 2026.
6. IPCC. Relatórios sobre mudança climática e impactos em ecossistemas terrestres (sínteses públicas). Acesso em: 2026.
7. COLÉGIO PAULO DE TARSO. ExpoPT — Manual de orientação às equipes: Voluntariado para o Meio Ambiente (ODS 15). 2026.

================================================================================

ANEXO — ROTEIRO DO TEMA DO GRUPO

Tema: Desmatamento e queimadas: voluntariado e tecnologia em defesa da Vida Terrestre (ODS 15).

Objetivo: Fazer o visitante da ExpoPT compreender o problema, relacioná-lo à ODS 15 e experimentar ferramentas digitais que incentivam a participação voluntária.

Público-alvo: Visitantes da ExpoPT (estudantes, famílias, professores e comunidade), com linguagem acessível a diferentes faixas etárias.

Materiais necessários:
1) Computador ou notebook com acesso à internet
2) Smartphone(s) para demonstrar a PWA EcoMind
3) Projetor ou monitor (quando disponível)
4) QR Code para o site https://eco-mind-ashy.vercel.app
5) Cartaz ou identificação do grupo EcoMind
6) Roteiro de apresentação impresso (apoio)

Passo a passo:
1) Acolher o visitante e apresentar o tema em até um minuto (problema + ODS 15).
2) Mostrar o site EcoMind e explicar a metáfora da semente que vira broto.
3) Convidar a participar do quiz ambiental.
4) Demonstrar o mapa de queimadas (dados INPE) e, se houver tempo, a calculadora de pegada de carbono.
5) Fechar com três ações voluntárias possíveis na escola ou na comunidade.
6) Responder perguntas e registrar feedbacks rápidos, se desejado.

Forma de participação dos visitantes: O visitante joga o quiz, explora o mapa, pode instalar o app no celular e conversa com o grupo sobre o que pode fazer como voluntário.

Resultado esperado: Ao sair, o visitante consegue responder: o que descobriu; por que o problema importa; o que pode fazer para ajudar; e como a tecnologia contribui.

================================================================================

2. ATIVIDADE LÚDICA / INTERATIVA

Nome: Quiz EcoMind — Desafio da consciência ambiental
Tipo: Quiz digital interativo (atividade digital / experiência interativa)

Relação com o tema: As perguntas abordam desmatamento, queimadas, clima e biodiversidade — o mesmo eixo da pesquisa e da ODS 15.

Objetivo educativo: Avaliar e ampliar o conhecimento do visitante de forma leve, com feedback imediato após cada resposta, reforçando a importância de agir.

Regras:
1) O visitante acessa o quiz no site ou no app EcoMind (rota /quiz).
2) Lê cada pergunta e escolhe uma das alternativas.
3) Recebe feedback educativo explicando a resposta correta com base em dados de fontes confiáveis.
4) Pode repetir o desafio e convidar outra pessoa do grupo/família a jogar.
5) Não há premiação obrigatória: o objetivo é aprender e conversar.
...
1) Problema: Poucas pessoas transformam a preocupação com desmatamento e queimadas em participação voluntária concreta.
2) Pesquisa: Estudo de causas, consequências, ODS 15, iniciativas reais e papel da tecnologia.
3) Ideia: Criar a EcoMind — plataforma digital de educação ambiental e convite à ação.
4) Desenvolvimento: Site/PWA com landing, quiz, calculadora de carbono e mapa de queimadas (INPE).
5) Teste: Validação das telas, da navegação mobile e da leitura dos dados no mapa.
6) Solução: Experiência completa apresentada na ExpoPT, acessível por QR Code e navegador.
7) Apresentação: Demonstração ao vivo, quiz com visitantes e explicação técnica e ambiental.

Critérios observados no desenvolvimento:
1) Criatividade na metáfora da marca (semente → broto) e na união de várias ferramentas em um só produto.
2) Relação teoria–prática: a pesquisa alimenta o conteúdo do site, do quiz e do discurso na feira.
3) Qualidade da proposta: interface coesa, dados reais e foco em voluntariado + ODS 15.
4) Uso dos conhecimentos do técnico: frontend, APIs, PWA, organização de componentes e experiência do usuário.
5) Funcionamento dos recursos: quiz, calculadora e mapa operacionais no ambiente de demonstração.
6) Participação de todos: design, programação, conteúdo e apresentação divididos entre a equipe.

Expectativas do 2º ano:
1) Maior autonomia e complexidade técnica em relação ao 1º ano.
2) Aplicação web completa (não apenas um protótipo isolado de uma tela).
3) Integração com dados externos (API de focos de queimadas / INPE).
4) Recursos interativos (quiz, calculadora) e instalação como PWA.
5) Justificativa técnica explícita das escolhas de stack e arquitetura.

Justificativa técnica (2º ano)
...
2) Tailwind CSS v4 (design system próprio da marca)
3) PWA (manifest + service worker)
4) Leaflet / react-leaflet (mapa)
5) API Route interna para focos de queimadas (INPE / FIRMS)
6) Deploy na Vercel (https://eco-mind-ashy.vercel.app)

Recursos do produto EcoMind:
1) Landing educativa (/): Apresenta o problema, a ideia, a equipe e o convite à ação.
2) Quiz ambiental (/quiz): Atividade lúdica com feedback baseado em dados.
3) Calculadora de pegada de carbono (/calculadora): Traduz hábitos cotidianos em impacto compreensível.
4) Mapa de queimadas (/alerta-queimadas): Visualização de focos com dados satelitais (INPE).
5) Página de instalação (PWA) (/baixar): Orienta o visitante a instalar o app no celular.
...
Integração / abertura: “Somos a equipe EcoMind. Nosso tema é voluntariado e tecnologia para proteger a Vida Terrestre — ODS 15 — com foco em desmatamento e queimadas.”

Problema: “Muita gente se preocupa, mas não sabe como ajudar. Falta uma ponte entre a notícia e a ação.”

Solução: “Criamos um app/site que educa, propõe um quiz e mostra dados reais de queimadas para incentivar a participação voluntária.”

Demo: “Vamos te mostrar o quiz e o mapa. Depois, contamos três coisas que você pode fazer na sua escola ou bairro.”

Fechamento: “Tecnologia não resolve sozinha — mas, com voluntariado, ajuda a proteger florestas, fauna e o nosso futuro.”

================================================================================

DESAFIO PARA OS VISITANTES

Ao final, o visitante da ExpoPT deve conseguir responder:

1) O que descobri?
2) Por que esse problema importa?
3) O que eu posso fazer para ajudar?
4) Como a tecnologia pode contribuir?
...
Colégio Paulo de Tarso · ExpoPT 2026 · EcoMind
Documento para impressão / PDF e entrega no Google Classroom.
Página digital no site: https://eco-mind-ashy.vercel.app/documentacao
